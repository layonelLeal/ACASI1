 ...
 * @author Lenovo
 */
public class ControladorGraficoDiasDelAño {
    ...
    public JFreeChart showBarChartDaysOfYear() throws ParseException{
        ...
        for(Map.Entry<String, Integer> month : monthData.entrySet()){
            ...
            dataset.setValue(value, "Fecha:", key);
        }
        
        JFreeChart chart = ChartFactory.createBarChart("Sesiones/Día del Año","Días del Año","Sesiones", 
    ...
    public JFreeChart showLinechartDaysOfYear() throws ParseException{
        ...
        //create chart
        JFreeChart linechart = ChartFactory.createLineChart("Sesiones/Día del Año","Días del Año","Sesiones", 
                dataset, PlotOrientation.VERTICAL, false, true, false);
