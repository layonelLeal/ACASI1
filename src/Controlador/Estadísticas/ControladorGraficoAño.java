 ...
 * @author Lenovo
 */
public class ControladorGraficoAño {
    ...
    public ControladorGraficoAño(VistaGrafico vistaGraficoMeses, Date start_time, Date finish_time, Integer sala_id) {
        ...
        try {
            ...
            Logger.getLogger(ControladorGraficoAño.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public JFreeChart showBarChartYear() throws ParseException{
        ...
        JFreeChart chart = ChartFactory.createBarChart("Sesiones/Año","Años","Sesiones", 
    ...
    public JFreeChart showLinechartYear() throws ParseException{
        ...
        //create chart
        JFreeChart linechart = ChartFactory.createLineChart("Sesiones/Año", "Meses", "Sesiones", 
                dataset, PlotOrientation.VERTICAL, false, true, false);
